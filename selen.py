...
if __name__=="__main__":
    ...
    for _ in range(500):
        ...
        try:
            browser.find_element_by_id("smb").click() # 크롬 F12누르면 결과 더보기의 id값 = smb
        except:
            print("Read more ... button has not found in this page.")
    ...
    for x in browser.find_elements_by_xpath('//div[contains(@class,"rg_meta")]'):
        ...
        try:
            urllib.request.urlretrieve(urls, os.getcwd()+"/"+searchterm+"/"+savename)#경로 및 파일명
            succounter += 1
        except:
